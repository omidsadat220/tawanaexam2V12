    ...
    <div class="row bg-secondary rounded mx-0 p-4 bg-auto-style custom-scroll" >
        <div class="col-12 text-center">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="{{ route('all.answer') }}" class="text-success d-flex align-items-center">
            ...
            <div class="row justify-content-center">   
                ...
                <!-- LEFT SIDE -->
                <div class="col-lg-6 col-md-12">
                    <form action="{{ route('update.set.exam', $exam->id) }}" method="POST">
                        @csrf
                        <div class="row mb-3 align-items-center">
                            <label for="exam-dropdown" class="col-sm-3 col-form-label text-white">Select Exam</label>
                            <div class="col-sm-9">
