        ...
        <div class="row bg-secondary">
            <div class="col-12 text-center">
                <div class="form-container container-form" id="add-category-page" style="display: block;">
                    ...
                    <form action="{{ route('update.teacher.new.question', $editData->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="container text-start p-4 bg-secondary rounded ">
                                    ...
                                    <select name="department_id" id="department-dropdown" class="form-select" required>
                                        ...
                                        @foreach ($departments as $dept)
                                            <option value="{{ $dept->id }}"
                                                {{ $editData->department_id == $dept->id ? 'selected' : '' }}>
                                                {{ $dept->depart_name }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select name="subject_id" id="subject-dropdown" class="form-select" required>
                                        ...
                                        @foreach ($subjects as $subject)
                                            <option value="{{ $subject->id }}"
                                                {{ $editData->subject_id == $subject->id ? 'selected' : '' }}>
                            ...
                            <!-- Question Text -->
                                    ...
                                    <div class="row mb-3 align-items-center">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control catinput" type="text" id="question"
                                                name="question" value="{{ $editData->question }}"required>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row mb-3 align-items-center">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="option{{ $i }}"
                                                    class="form-control catinput" value="{{ $editData->{'option' . $i} }}" required>
                                            </div>
                                        </div>
                                    @endfor
                                    ...
                                    <div class="row mb-3 align-items-center">
                                        ...
                                        <img id="showImage" src="{{ !empty($editData->image) ? asset($editData->image) : url('upload/no_image.jpg') }}" style="width:150px; height 150px;">
                                    </div>
