                    ...
                    <div class="row">
                        <div class="col-12 d-flex align-items-center justify-content-between mb-4">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <a href="{{ route('add.teacher.set.exam') }}">
                                ...
                                <tbody>
                                    @foreach ($examQuestions as $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('edit.teacher.set.exam', $item->exam_id) }}" class="btn btn-primary btn-sm">Edit</a>
                                                <a href="{{ route('delete.teacher.set.exam', $item->exam_id) }}" class="btn btn-danger btn-sm" id="delete">Delete</a>
                                        </tr>
                                    @endforeach
                                </tbody>
